...
<!-- 
    ...
    * RouterLink
    ...
    - RouterLink는 다음과 같은 속성들을 가지고 있다.
        ...
        2) active-class: 현재 라우트와 일치할 때 적용할 css클래스를 지정(활성화 되었던 RouterLink에 css 적용 시 사용)

    * RouterView
    - 현재 라우트에 해당하는 컴포넌트를 렌더링하는 지점을 정하기 위해 사용된다.
    - vue-router가 현재 uri에 따라 매칭되는 컴포넌트를 찾으면, 
        해당 컴포넌트를 RouterView 내부에 렌더링하여 이를 통해 페이지 간의 전환을 구현할 수 있다.
